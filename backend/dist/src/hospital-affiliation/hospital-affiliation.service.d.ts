...
export declare class HospitalAffiliationService {
    ...
    create(data: CreateHospitalAffiliationDto): import(".prisma/client").Prisma.Prisma__HospitalAffiliationClient<{
        id: number;
        doctorId: number;
        hospitalName: string;
        city: string;
    ...
    update(id: number, data: UpdateHospitalAffiliationDto): import(".prisma/client").Prisma.Prisma__HospitalAffiliationClient<{
        id: number;
        doctorId: number;
        hospitalName: string;
        city: string;
