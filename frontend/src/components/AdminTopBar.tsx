...
export default function AdminTopBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 h-12 bg-gradient-to-r from-[#1a4fc4] to-[#2d6be4] flex items-center justify-between px-6 shadow-md">
      {/* Left — logo */}
      <div className="flex items-center gap-2.5">
        ...
        <span className="text-blue-300 text-xs ml-1 hidden sm:block">· Admin Portal</span>
      </div>

      {/* Right — date, admin info, bell, logout */}
      <div className="flex items-center gap-4">
        <p className="text-blue-200 text-xs hidden md:block">{dateStr}</p>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs bg-white/20 text-white px-2 py-0.5 rounded-full font-medium ml-1">Administrator</span>
        </div>
